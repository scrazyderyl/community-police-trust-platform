...
import LinkPreviewOverlay from "@/components/jurisdiction_info_editor/LinkPreviewOverlay";
import FeedbackOverlay from "@/components/jurisdiction_info_editor/FeedbackOverlay";
...
export default function JurisdictionInfoForm() {
  ...
  const [linkPreview, setLinkPreview] = useState({ open: false, url: "", docIdx: -1 });
        ...
        {({ values, setFieldValue, errors, submitCount }) => {
          ...
          return <Form className="space-y-6">
            <div className="flex gap-8">
              {/* Left static section */}
              <div className="bg-white rounded-xl shadow mt-10 mb-10 p-8 w-120 h-fit sticky top-10">
                {/* Title */}
                                    ...
                                    if (!isUrlValid) {
                                      ...
                                      return (
                                        <button
                                          ...
                                          onClick={() => {
                                            setLinkPreview({ open: true, url: doc.url, docIdx: idx });
                                          }}
            ...
            <LinkPreviewOverlay
              ...
              url={linkPreview.url}
              onClose={() => setLinkPreview({ ...linkPreview, open: false })}
              onConfirm={() => {
