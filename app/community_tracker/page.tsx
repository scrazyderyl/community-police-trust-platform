...
const Community_tracker = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-100">
      ...
      {/* Informational Text */}
      <p className="w-3/4 text-center bg-gray-200 p-5 text-black-500 text-sm mt-4 rounded-md leading-relaxed">
        This page contains community-reported cases when they filed a police
        complaint in Allegheny County. The data will not be complete since not
        all community members use this website. We show only the counts, and
        nothing personal is collected or shown here. We also show data from the
        last one year.
      </p>
      ...
      <div className="flex items-center justify-center mt-6 space-x-4">
        ...
        <a
          href="/update_record/update_portal"
          className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-6 rounded-md"
        >
          Update Record
        </a>
